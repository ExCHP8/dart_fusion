...
/// An asset class scanned from `assets`, containing 1 files.
/// 
/// ```dart
...
/// An asset class scanned from `assets/translation`, containing 2 files.
/// 
/// ```dart
...
class TranslationAssets {
  ...
  /// Asset derived from `assets/translation/en_id.json`, with 0 B size.
  /// 
  /// ```dart
  /// String value = TranslationAssets.en_id;
  /// ```
  static const String en_id = 'assets/translation/en_id.json';

  /// Asset derived from `assets/translation/en_us.txt`, with 0 B size.
  /// 
  /// ```dart
  /// String value = TranslationAssets.en_us;
  /// ```
  static const String en_us = 'assets/translation/en_us.txt';
